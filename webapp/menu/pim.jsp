      ...
      <aside id="m-sidebar" class="accordion span2" data-spy="affix" data-offset-top="100">
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-bpm-process" class="accordion-body collapse ${currentMenu == 'bpm-process' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${tenantPrefix}/bpm/workspace-home.do"><i class="icon-user"></i>发起新流程</a></li>
			  <li><a href="${tenantPrefix}/bpm/workspace-listRunningProcessInstances.do"><i class="icon-user"></i>运行的流程</a></li>
			  <li><a href="${tenantPrefix}/bpm/workspace-listCompletedProcessInstances.do"><i class="icon-user"></i>办结的流程</a></li>
			  <li><a href="${tenantPrefix}/bpm/workspace-listInvolvedProcessInstances.do"><i class="icon-user"></i>参与的流程</a></li>
			  <li><a href="${tenantPrefix}/operation/process-operation-listDrafts.do"><i class="icon-user"></i>草稿箱</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-bpm-task" class="accordion-body collapse ${currentMenu == 'bpm-task' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${tenantPrefix}/humantask/workspace-personalTasks.do"><i class="icon-user"></i>待办任务</a></li>
			  <li><a href="${tenantPrefix}/humantask/workspace-groupTasks.do"><i class="icon-user"></i>待领任务</a></li>
			  <li><a href="${tenantPrefix}/humantask/workspace-historyTasks.do"><i class="icon-user"></i>已办任务</a></li>
			  <li><a href="${tenantPrefix}/humantask/workspace-delegatedTasks.do"><i class="icon-user"></i>代理中的任务</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-bpm-delegate" class="accordion-body collapse ${currentMenu == 'bpm-delegate' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${tenantPrefix}/delegate/delegate-prepareAutoDelegate.do"><i class="icon-user"></i>设置自动委托</a></li>
			  <li><a href="${tenantPrefix}/delegate/delegate-listMyDelegateInfos.do"><i class="icon-user"></i>自动委托规则</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-msg" class="accordion-body collapse ${currentMenu == 'msg' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${tenantPrefix}/msg/msg-info-listReceived.do"><i class="icon-user"></i>收件箱</a></li>
			  <li><a href="${tenantPrefix}/msg/msg-info-listSent.do"><i class="icon-user"></i>发件箱</a></li>
			  <li><a href="${tenantPrefix}/msg/msg-info-input.do"><i class="icon-user"></i>新建消息</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-address-list" class="accordion-body collapse ${currentMenu == 'address-list' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${tenantPrefix}/pim/address-list-list.do"><i class="icon-user"></i>通讯录</a></li>
              <li><a href="${tenantPrefix}/pim/pim-info-list.do"><i class="icon-user"></i>联系人</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-note" class="accordion-body collapse ${currentMenu == 'note' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${tenantPrefix}/pim/pim-note-list.do"><i class="icon-user"></i>便签</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-workReport" class="accordion-body collapse ${currentMenu == 'workReport' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${tenantPrefix}/pim/work-report-info-list.do"><i class="icon-user"></i>日报</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-favorite" class="accordion-body collapse ${currentMenu == 'favorite' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${tenantPrefix}/pim/pim-favorite-list.do"><i class="icon-user"></i>收藏</a></li>
            </ul>
          </div>
        </div>
